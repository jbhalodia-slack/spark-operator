...
import (
	...
	sparkoperatorapiv1beta2 "github.com/kubeflow/spark-operator/api/v1beta2"
	versioned "github.com/kubeflow/spark-operator/client-go/clientset/versioned"
	internalinterfaces "github.com/kubeflow/spark-operator/client-go/informers/externalversions/internalinterfaces"
	apiv1beta2 "github.com/kubeflow/spark-operator/client-go/listers/api/v1beta2"
...
func NewFilteredScheduledSparkApplicationInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&sparkoperatorapiv1beta2.ScheduledSparkApplication{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *scheduledSparkApplicationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sparkoperatorapiv1beta2.ScheduledSparkApplication{}, f.defaultInformer)
}
